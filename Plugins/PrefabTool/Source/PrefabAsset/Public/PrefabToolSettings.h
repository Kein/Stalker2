...
public:
    ...
    UPROPERTY(Config, EditAnywhere)
    FString DuplicateLevelForPackagingPostfix;
    
    UPROPERTY(Config, EditAnywhere)
    bool bSaveCurrentLevelBeforeDuplicate;
    ...
    UPROPERTY(Config, EditAnywhere)
    bool bEnableRevertPrefabOnCellLoaded;
    ...
    UPROPERTY(Config, EditAnywhere)
    int32 RealtimeThumbnailThreshold;
    
    UPROPERTY(Config, EditAnywhere)
    bool bShouldDoApplyAfterGroupActorOperations;
