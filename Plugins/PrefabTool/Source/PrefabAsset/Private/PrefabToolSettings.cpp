...
UPrefabToolSettings::UPrefabToolSettings() {
    ...
    this->NewPrefabNamePattern = TEXT("P_NewPrefab");
    this->DuplicateLevelForPackagingPostfix = TEXT("_ForCook");
    this->bSaveCurrentLevelBeforeDuplicate = false;
    ...
    this->bEnableRevertPrefabOnCellLoaded = true;
    ...
    this->RealtimeThumbnailThreshold = 0;
    this->bShouldDoApplyAfterGroupActorOperations = false;
}
