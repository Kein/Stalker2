#include "CustomConsoleManagerIK.h"

UCustomConsoleManagerIK::UCustomConsoleManagerIK() {
}
...
void UCustomConsoleManagerIK::XInputActionUnlock(const FString& IAName, const FString& IMCName) const {
}

void UCustomConsoleManagerIK::XInputActionBlock(const FString& IAName, const FString& IMCName) const {
}
