#include "CustomConsoleManagerSD.h"

UCustomConsoleManagerSD::UCustomConsoleManagerSD() {
}

void UCustomConsoleManagerSD::XTeleportToPlacesOfInterest(const FString& SID) const {
}
