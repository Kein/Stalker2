#include "CustomConsoleManagerOA.h"

UCustomConsoleManagerOA::UCustomConsoleManagerOA() {
}

void UCustomConsoleManagerOA::XPlayVideo(const FString& Path) const {
}
...
void UCustomConsoleManagerOA::XHasDLC(const FName DLCName) const {
}
