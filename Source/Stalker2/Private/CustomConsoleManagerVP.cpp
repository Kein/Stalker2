#include "CustomConsoleManagerVP.h"

UCustomConsoleManagerVP::UCustomConsoleManagerVP() {
}
...
void UCustomConsoleManagerVP::XLaunchFacialAnimation(const int32 ObjUID, const FString& AnimPath) const {
}
