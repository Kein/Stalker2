#include "CustomConsoleManagerMY.h"

UCustomConsoleManagerMY::UCustomConsoleManagerMY() {
}

void UCustomConsoleManagerMY::XSimulatePhysicsOnBoneForObj(int32 ObjUID, const FString& BoneName) const {
}
