#include "CustomConsoleManagerVC.h"

UCustomConsoleManagerVC::UCustomConsoleManagerVC() {
}
...
void UCustomConsoleManagerVC::XEnterRegion(const FString& RegionSID) {
}
...
void UCustomConsoleManagerVC::XAddPDATutorialsBySID(const FString& InPDATutorialPrototypeSID) {
}

void UCustomConsoleManagerVC::XAddNotesById(const FString& InNotePrototypeID) {
}
