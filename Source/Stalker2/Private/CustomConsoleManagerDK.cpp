#include "CustomConsoleManagerDK.h"

UCustomConsoleManagerDK::UCustomConsoleManagerDK() {
}
...
void UCustomConsoleManagerDK::XDKStartTwoQuestStage(const FString& QSID) const {
}

void UCustomConsoleManagerDK::XDKStartQuestStage(const FString& QSID, const FString& SSID) const {
}

void UCustomConsoleManagerDK::XDKStartQuest(const FString& SID) const {
}

void UCustomConsoleManagerDK::XDKFinishQuestStage(const FString& QSID, const FString& SSID, const bool bWin) const {
}

void UCustomConsoleManagerDK::XDKFinishQuest(const FString& SID, const bool bWin) const {
}
