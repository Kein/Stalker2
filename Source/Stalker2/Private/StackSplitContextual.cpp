...
UStackSplitContextual::UStackSplitContextual() : UUserWidget(FObjectInitializer::Get()) {
    this->ConfirmHint = NULL;
    this->ConfirmAllHint = NULL;
    this->CancelHint = NULL;
    this->TitleText = NULL;
    this->Slider_ItemSplit = NULL;
    this->SplitTextTest = NULL;
    this->ItemName = NULL;
    this->SizeBoxSlider = NULL;
    this->OverlayNumbers = NULL;
    this->OverlaySize = NULL;
    this->SliderImage = NULL;
    this->MovementCurve = NULL;
    this->ArrowLeft = NULL;
    this->ArrowRight = NULL;
    this->ArrowRightPlatformSwitcher = NULL;
    this->ArrowLeftPlatformSwitcher = NULL;
