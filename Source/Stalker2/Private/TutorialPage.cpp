...
UTutorialPage::UTutorialPage() {
    this->TutorialDetails = NULL;
    this->ButtonAll = NULL;
    this->ButtonNavigation = NULL;
    this->ButtonFight = NULL;
    this->ButtonSurvival = NULL;
    this->ButtonEarning = NULL;
    this->TutorialPanel = NULL;
    this->DefaultOpenFilter = 0;
    this->TutorialSlotListScrollTime = 0.50f;
}
...
void UTutorialPage::ClickButtonMenu(const FName ButtonId) {
}
