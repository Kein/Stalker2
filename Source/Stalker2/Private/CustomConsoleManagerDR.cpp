#include "CustomConsoleManagerDR.h"

UCustomConsoleManagerDR::UCustomConsoleManagerDR() {
}

void UCustomConsoleManagerDR::XSwitchToWeather(const EWeather WeatherType) const {
}

void UCustomConsoleManagerDR::XInitializeBenchmarkSequence(const FString& AssetPath, const FString& AssetName) {
}
