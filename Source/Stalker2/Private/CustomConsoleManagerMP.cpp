#include "CustomConsoleManagerMP.h"

UCustomConsoleManagerMP::UCustomConsoleManagerMP() {
}
...
void UCustomConsoleManagerMP::XDisplayArtifactSpawnLuckStatus(const FString& ArtifactSpawnerSID) {
}
