#include "CustomConsoleManagerDP.h"

UCustomConsoleManagerDP::UCustomConsoleManagerDP() {
}
...
void UCustomConsoleManagerDP::XPrintLocalizedTextByKey(const FString& StringKey) const {
}
