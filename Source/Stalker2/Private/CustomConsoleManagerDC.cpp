#include "CustomConsoleManagerDC.h"

UCustomConsoleManagerDC::UCustomConsoleManagerDC() {
}
...
void UCustomConsoleManagerDC::XShowDebugInfoForStash(const FString& InStashIdentifier) {
}

void UCustomConsoleManagerDC::XSetWeatherTransitionTimeMultiplier(const float WeatherTransitionTimeMultiplier) {
}

void UCustomConsoleManagerDC::XSetCurrentCode(const FString& InCurrentCode) {
}

void UCustomConsoleManagerDC::XRegenerateItemsInStashes() {
}

void UCustomConsoleManagerDC::XNPCRemoveAbility(const int32 NpcUID, const FString& AbilityTag) {
}

void UCustomConsoleManagerDC::XNPCAddAbility(const int32 NpcUID, const FString& AbilityTag) {
}
