#include "CustomConsoleManagerBuild.h"

UCustomConsoleManagerBuild::UCustomConsoleManagerBuild() {
}

void UCustomConsoleManagerBuild::XSpawnItemNearPlayerBySID(const FString& ItemPrototypeSID) const {
}

void UCustomConsoleManagerBuild::XSpawnItemInCoordinatesBySID(const FString& ItemPrototypeSID, float Px, float Py, float Pz) const {
}
...
void UCustomConsoleManagerBuild::XSetFactionGodMode(const FString& CurrentFactionSelector, bool bGodModeState) const {
}
