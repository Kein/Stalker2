#include "CustomConsoleManagerMH.h"

UCustomConsoleManagerMH::UCustomConsoleManagerMH() {
}
...
void UCustomConsoleManagerMH::XRemoveEffectFromPlayer(const FString& EffectPrototypeSID) {
}

void UCustomConsoleManagerMH::XApplyMainHandWeaponUpgradeBySID(const FString& UpgradePrototypeSID) const {
}
